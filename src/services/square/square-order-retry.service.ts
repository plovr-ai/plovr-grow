...
async function executeRetry(payload: OrderPushRetryPayload): Promise<void> {
...
async function retryFailedOrderPushes(
  batchSize: number = 20
...
export const squareOrderRetryService = {
  retryFailedOrderPushes,
};
