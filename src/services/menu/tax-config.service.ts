 ...
 */
async function getTaxConfigsMap(
  tenantId: string,
  ids: string[]
 ...
 */
async function getMerchantTaxConfigs(merchantId: string): Promise<MerchantTaxConfig[]> {
  const repository = await getRepository();
 ...
 */
async function getTaxConfigsWithRates(
  tenantId: string,
 ...
 */
async function getTaxConfigInfo(
  tenantId: string,
  id: string
 ...
 */
async function deleteTaxConfig(tenantId: string, id: string): Promise<void> {
  const repository = await getRepository();
 ...
 */
async function setMerchantTaxRate(
  merchantId: string,
  taxConfigId: string,
  rate: number
): Promise<void> {
 ...
 */
async function setMenuItemTaxConfigs(
  tenantId: string,
  itemId: string,
  taxConfigIds: string[]
): Promise<void> {
