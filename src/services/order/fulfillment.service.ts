 ...
 */
async function transitionStatusByFulfillmentId(
  tenantId: string,
 ...
 */
async function getFulfillmentByOrderId(tenantId: string, orderId: string) {
 ...
 */
async function getStatusHistory(tenantId: string, fulfillmentId: string): Promise<StatusLogEntry[]> {
 ...
 */
async function bumpExternalVersion(
  fulfillmentId: string,
...
export const fulfillmentService = {
  createFulfillment,
  transitionStatus,
  transitionStatusByFulfillmentId,
