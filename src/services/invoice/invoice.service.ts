...
export class InvoiceService {
   ...
   */
  async getInvoiceByCateringOrderId(
    tenantId: string,
    cateringOrderId: string
  ): Promise<InvoiceWithCateringOrder | null> {
   ...
   */
  async markAsPaid(tenantId: string, invoiceId: string): Promise<void> {
   ...
   */
  async handlePaymentCompleted(invoiceNumber: string): Promise<void> {
