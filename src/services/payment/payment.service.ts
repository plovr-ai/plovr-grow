...
const provider = new StripeConnectStandardProvider();
 ...
 */
async function createPaymentRecord(input: CreatePaymentRecordInput, tx?: DbClient) {
...
async function verifyPayment(
  ...
  const paymentIntent = await provider.retrievePaymentIntent(
    paymentIntentId,
    stripeAccountId
  );
 ...
 */
async function getPaymentByOrderId(tenantId: string, orderId: string) {
 ...
 */
async function getSuccessfulPaymentByOrderId(tenantId: string, orderId: string) {
 ...
 */
async function getPaymentByProviderPaymentId(
 ...
 */
async function providerPaymentExists(
  provider: PaymentProvider,
  providerPaymentId: string
): Promise<boolean> {
