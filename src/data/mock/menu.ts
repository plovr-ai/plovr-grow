      ...
      items: [
        {
          ...
          isAvailable: true,
          taxes: [{ taxConfigId: "tax-standard", name: "Standard Tax", rate: 0.0825, roundingMethod: "half_up" }],
        },
        {
          id: "item-2",
      ...
      items: [
        {
          ...
          isAvailable: true,
          taxes: [{ taxConfigId: "tax-reduced", name: "Reduced Tax", rate: 0.05, roundingMethod: "half_up" }],
        },
        {
          id: "item-12",
          name: "Italian Soda",
