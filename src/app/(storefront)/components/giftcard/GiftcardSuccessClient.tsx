...
import { LoyaltyRegistrationCTA } from "@storefront/components/orders/LoyaltyRegistrationCTA";

interface GiftcardSuccessClientProps {
  order: {
    id: string;
    orderNumber: string;
    totalAmount: number;
