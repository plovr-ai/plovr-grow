...
import { GrowAgentHero } from "@/components/website/sections/grow-agent/GrowAgentHero";
import { GrowAgentValueProp } from "@/components/website/sections/grow-agent/GrowAgentValueProp";
...
export const metadata: Metadata = {
  title: `Grow Agent - Your AI Growth Squad | ${siteConfig.name}`,
  description:
    "From SEO to Social Media, our specialized agents manage your entire online presence to drive consistent foot traffic and reclaim your margins.",
  openGraph: {
    title: `Grow Agent - Your AI Growth Squad | ${siteConfig.name}`,
    description:
      "From SEO to Social Media, our specialized agents manage your entire online presence to drive consistent foot traffic and reclaim your margins.",
    url: `${siteConfig.url}/grow-agent`,
...
export default function GrowAgentPage() {
  return (
    <>
      <GrowAgentHero />
