...
export const metadata: Metadata = {
  title: "AI Voice Agent for Restaurants | Localgrow",
  description:
    "Stop losing revenue to missed calls. Our AI Voice Agent handles 100% of your phone orders with human-like precision, 24/7.",
  openGraph: {
    title: "AI Voice Agent for Restaurants | Localgrow",
    description:
      "Stop losing revenue to missed calls. Our AI Voice Agent handles 100% of your phone orders with human-like precision, 24/7.",
    url: `${siteConfig.url}/lp/voice-agent`,
...
const costCards = [
  {
    ...
    description: "Most restaurants miss 30% of calls during peak hours.",
  },
  {
    iconSvg: (
...
export default function VoiceAgentLandingPage() {
  return (
    <>
      ...
      <FAQ title="Common Questions" items={faqItems} variant="card" />
