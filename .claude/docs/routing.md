...
| Storefront | `http://localhost:3000/r/{merchantSlug}/orders/{orderId}` | 订单详情 |
| Storefront | `http://localhost:3000/r/{merchantSlug}/catering` | 餐饮承包 |
